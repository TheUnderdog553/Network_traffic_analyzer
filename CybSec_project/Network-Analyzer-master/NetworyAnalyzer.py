...
def menu2(data_file):
    ...
    if(option_menu2 == 1):  #Proceeds to show_data() w
        os.system('cls')
        show_data(data_file)
...
def about():
    ...
    print("This is developed solely for use in Windows OS. ")
...
def start_screen():
    ...
    # this will prevent program from crashing when no required inputs are passed
    except ValueError:
        os.system('cls')
        banner()
